...
const defaultSignInContent = {
    image: {
        ...
        alt: "Vibrant abstract network visualization"
    },
    quote: {
...
const defaultSignUpContent = {
    image: {
        src: "https://images.unsplash.com/photo-1642543492481-44e81e3914a7?q=80&w=2832&auto=format&fit=crop",
        alt: "Vibrant abstract crypto visual art"
    },
    quote: {
    ...
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-end p-2 pb-6">
            <blockquote className="space-y-2 text-center text-foreground font-sans">
              <p className="text-lg font-medium text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                “<Typewriter
              ...
              <cite className="block text-sm font-light text-gray-300 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] not-italic">
