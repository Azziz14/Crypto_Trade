...
// Hero Component
export const Hero = React.memo(({ onStartTrading }: { onStartTrading?: () => void }) => {
  return (
    <section
    ...
    >
      ...
      <aside className="mb-8 inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full border border-gray-750 bg-gray-800/50 backdrop-blur-sm max-w-full">
        <span className="text-xs text-center whitespace-nowrap" style={{ color: '#9ca3af' }}>
          Virtual INR Simulator is live!
        </span>
        <a
          href="#dashboard"
      ...
      >
        Give your crypto trades <br />the simulator they deserve
      </h1>

      <p className="text-sm md:text-base text-center max-w-2xl px-6 mb-10" style={{ color: '#9ca3af' }}>
        Real-time paper trading simulator with Indian Rupee (₹) virtual balance, <br />live order books, and advanced terminal analytics.
      </p>
